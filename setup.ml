...
(* OASIS_START *)
(* DO NOT EDIT (digest: e1719210533e73cf759afdb997abc73f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Tracing tools";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("nocrypto.lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "read_pinata_trace.ml"
                   });
               Doc
                 ({
                     cs_name = "api";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\213\012\210\162\155\178`\147\240V\255*+\"\007\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
